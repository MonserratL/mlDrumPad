...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound3 = sp.load(getApplicationContext(), R.raw.sound1,1);
        sound4 = sp.load(getApplicationContext(), R.raw.sound1,1);
        sound5 = sp.load(getApplicationContext(), R.raw.sound1,1);
        sound6 = sp.load(getApplicationContext(), R.raw.sound1,1);
        sound7 = sp.load(getApplicationContext(), R.raw.sound1,1);
        sound8 = sp.load(getApplicationContext(), R.raw.sound1,1);
        sound9 = sp.load(getApplicationContext(), R.raw.sound1,1);
    }
